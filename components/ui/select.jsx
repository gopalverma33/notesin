            ...
            <div className="p-2 border-b border-gray-200">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-2 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
              </div>
            </div>
          )}
            ...
            {filteredOptions.length > 0 ? (
              filteredOptions.map((option) => (
                <button
                  ...
                  className={cn(
                    'w-full text-left px-3 py-2 text-sm rounded hover:bg-gray-100 focus:bg-gray-100 focus:outline-none',
